...
{
	var clientId = "u-s4t2ud-0100c84c9571f0038bb00b43dd71dece8fe33ce343dc90486c300846eae5f32f";
	var redirectUri = encodeURIComponent("http://127.0.0.1:8000/personal-info/");
	var scope = encodeURIComponent("public");
	var state = encodeURIComponent("very_long_string_that_is_unguessuable");

	var authorizationUrl = "https://api.intra.42.fr/oauth/authorize" + 
        "?client_id=" + clientId +
